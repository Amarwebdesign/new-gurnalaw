  ...
  return (
    <section className="bcpnpform">
        ...
        <div className='text-center py-[100px]'>
            <h1 className="lg:text-[50px] text-[24px] font-bold">BC PNP Calculator – New Version ({new Date().getFullYear()})</h1>
            <p className="mt-5 text-[18px] lg:text-[20px]">Points are calculated based on the information provided. Redefine Immigration does not hold any responsibility for getting ITA from BC PNP.</p>
        </div>
    <div className='grid grid-cols-1 md:grid-cols-12 gap-[50px] mb-5 '>

        <div className=" md:col-span-3">
            <div className="lg:sticky lg:top-[100px] fixed top-[60px] left-0 right-0 z-10 w-full tootal-score bg-[#fbb033] p-4 lg:p-8 lg:rounded grid grid-cols-12 items-center lg:block lg:text-center" id="form-total">
                 <div id="fieldname1_1" className=" col-span-2">0</div>
                <div className=' col-span-10 text-[16px]'>Total points under British Columbia Province Nominee Program (BC PNP):</div>
            </div>
        </div>
