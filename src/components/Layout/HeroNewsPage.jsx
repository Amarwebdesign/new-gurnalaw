...
export default function HeroNewsPage({
    title,
    content,
    heroimage
}) {
    //const postimg=heroimage.node.sourceUrl
    console.log(heroimage.node.sourceUrl);
  return (
    <>
        <div className="relative z-30 text-white inner-banner-section before:bg-black/60 before:absolute before:left-0 before:top-0 before:right-0 before:bottom-0" style={{ backgroundImage: `url(${heroimage.node.sourceUrl})` }}>
                ...
                <div className="min-h-[70vh] flex items-center justify-between pt-[150px] pb-[50px]">
                    <div className="law-hero-info max-w-[650px] xl:max-w-[850px]">
                        <div className="law-hero__content">
                            <h1 className="mb-5 font-bold text-[30px] lg:text-[50px]" data-aos="fade-up">{title}</h1>
                            <p className="mb-50">
                            {content}
                            </p>
