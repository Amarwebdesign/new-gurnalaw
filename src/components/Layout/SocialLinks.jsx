...
<>
	<Link href={link} className="relative group/link bg-black bg-opacity-50 h-[70px] flex items-center justify-center">
		...
		<div className="absolute top-0 left-0 w-full h-0 group-hover/link:h-full bg-[#fbb033] opacity-50 transition-all duration-[.5s] delay-[.25s] group-hover:delay-[0s]"></div>
		<div className="absolute top-0 left-0 w-full h-0 group-hover/link:h-full bg-[#fbb033] transition-all duration-[.5s] group-hover/link:delay-[.25s]"></div>
		<div className="relative text-lg font-semibold group-hover/link:text-black transition-all duration-[0.5s]">{name}</div>
	</Link>
</>
  );
}
