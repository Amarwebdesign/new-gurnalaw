            ...
            <div className="gl-offcanvas__widget my-5 d-none d-xl-block">
                <div className="gl-offcanvas-cta flex items-center tp-border-bottom pb-4 mb-6">
                    ...
                    <span>
                        ...
                        <b><a href="tel:+16042613171">+1-604-261-3171 </a></b>
                        <b><a href="tel:+16045473133">+1-604-547-3133 </a></b>
                    </span>
                </div>
                <div className="gl-offcanvas-cta flex items-center tp-border-bottom pb-4 mb-6">
                    ...
                    <span>
                        ...
                        <b><a href="mailto:legal@gurnalaw.ca">legal@gurnalaw.ca</a></b>
                    </span>
                </div>
                <div className="gl-offcanvas-cta flex items-center pb-4 mb-6">
                    ...
                    <span>
                        ...
                        <b><a href="https://maps.app.goo.gl/yMj9fZqRMfa2sWa68" target="_blank">Unit 208–8028, 128th St., Surrey, BC, V3W4E9</a></b>
                    </span>
                </div>
            </div>
