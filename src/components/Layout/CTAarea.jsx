...
export default function CtaArea( {
    ...
    <>
        <div className="section law-cta-area text-center pt-120 pb-120">
            ...
            <SectionHeading
                minititlecolor="text-blue" minititle="Contact Us To Better Understand Your Case"
            ...
            <div className="mt-5 law-cta-contact-wrapper">
                ...
                <div className="my-5"><a href="tel:+16042613171" className="text-[40px] font-bold text-primary">+1-604-261-3171</a></div>
