      ...
      <section className="py-16">
        <Container>
          <div className="max-w-4xl mx-auto">
            <SectionHeading title="Why Choose Our Coquitlam Immigration Lawyers?" />
            <div className="mt-8 space-y-6">
              <p className="text-lg text-gray-700">
                Located in the heart of Coquitlam, our experienced immigration lawyers provide comprehensive legal services
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-green-50 p-6 rounded-lg">
                  <h3 className="text-xl font-semibold mb-3">Why Coquitlam?</h3>
                  <ul className="space-y-2 text-gray-600">
