            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-[40px]">
              ...
              <div id="tab-accordion" className="col-span-2 faq-accordion" itemScope itemType="https://schema.org/FAQPage">
                <FaqItem
                  ...
                  answer="Gurna Law Corporation specializes in a range of immigration services in Abbotsford, including visa applications, family sponsorship, and deportation defense."
                />
                <FaqItem
